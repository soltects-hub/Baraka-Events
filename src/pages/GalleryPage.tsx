...
const photos: { src: string; alt: string; category: (typeof categories)[number] }[] = [
  { src: '/media/gallery-1.jpg', alt: 'Nikkah stage florals at a wedding decoration setup in Lahore', category: 'Weddings' },
  { src: '/media/gallery-2.jpg', alt: 'Ivory and gold wedding cake with mithai display, Lahore wedding decor', category: 'Weddings' },
  { src: '/media/gallery-6.jpg', alt: 'Dhol drummers leading a baraat procession at a Lahore shaadi', category: 'Weddings' },
  { src: '/media/wedding-1.jpg', alt: 'Nikkah stage with candlelight, wedding planner Lahore', category: 'Weddings' },
  { src: '/media/gallery-5.jpg', alt: 'Marigold and jasmine garlands, mehndi decoration Lahore', category: 'Weddings' },
  { src: '/media/private-1.jpg', alt: 'Mehndi night dancing and celebration, Mehndi event planner Lahore', category: 'Weddings' },
  ...
  { src: '/media/showcase-4.jpg', alt: 'Corporate gala floor with choreographed intelligent lighting', category: 'Corporate & Live' },
  { src: '/media/showcase-5.jpg', alt: 'Five-star hospitality reception service at a corporate event in Lahore', category: 'Corporate & Live' },
  { src: '/media/showcase-6.jpg', alt: 'Certified rigging and truss for a live event production', category: 'Corporate & Live' },
  { src: '/media/corporate-1.jpg', alt: 'Corporate event management stage set in Lahore', category: 'Corporate & Live' },
  { src: '/media/portfolio-2.jpg', alt: 'Corporate product launch on stage at Expo Centre Lahore', category: 'Corporate & Live' },
  { src: '/media/portfolio-4.jpg', alt: 'Corporate awards dinner in a Gulberg grand ballroom', category: 'Corporate & Live' },
  { src: '/media/portfolio-3.jpg', alt: 'Private rooftop birthday celebration in the Walled City, Lahore', category: 'Private' },
  { src: '/media/design-1.jpg', alt: 'Keynote conference stage concept render, 3D event design Lahore', category: 'Design Concepts' },
  { src: '/media/design-2.jpg', alt: 'Corporate dinner concept render with suspended light rings', category: 'Design Concepts' },
  { src: '/media/design-3.jpg', alt: 'Product reveal stage concept render with curved LED wall', category: 'Design Concepts' },
];
