            ...
            <div className="flex flex-wrap items-center gap-3">
              {[
                ...
                <a
                  ...
                  className="group flex h-11 w-11 items-center justify-center rounded-full border border-white/12 bg-white/[0.04] backdrop-blur-md transition-all duration-300 hover:border-gold/60 hover:bg-gold/10"
                >
                  <svg viewBox="0 0 32 32" className="h-[18px] w-[18px] fill-cream/60 transition-colors duration-300 group-hover:fill-gold">
                    {s.icon}
                  </svg>
                </a>
              ))}
