      ...
      <div className="mx-auto grid max-w-[1400px] gap-16 px-6 md:px-10 lg:grid-cols-[1fr_1.4fr] lg:gap-24">
        <div className="lg:sticky lg:top-28 lg:h-fit">
          ...
          <RevealText
            ...
            className="font-display text-4xl font-light leading-[1.12] md:text-6xl"
            highlightWords={[4, 5, 6]}
        ...
        <div ref={ref} className="relative">
          ...
          <motion.div style={{ height: lineHeight }} className="absolute left-[19px] top-0 w-[1px] bg-gradient-to-b from-champagne via-champagne to-gold md:left-[27px]" />
          ...
          <div className="space-y-14 md:space-y-20">
            {steps.map((step, i) => (
              ...
              >
                <div className="accent-serif relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-bronze/60 bg-ink-3 text-base shadow-[0_10px_30px_-12px_rgba(0,0,0,0.9)] md:h-14 md:w-14 md:text-lg">
                  {step.n}
                </div>
                <div className="pt-1">
                  <h3 className="font-display text-2xl font-light md:text-4xl">{step.title}</h3>
